...
| Status  | Description                                                               |
| ------- | ------------------------------------------------------------------------- |
| On      | Local gateway is running, usually at `127.0.0.1:15722`                    |
...
~/Library/Application Support/Claude-3p/configLibrary/00000000-0000-4000-8000-000000157220.json
```
...
%LOCALAPPDATA%\Claude-3p\configLibrary\00000000-0000-4000-8000-000000157220.json
```
