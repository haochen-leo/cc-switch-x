...
- **Automatic backup**: Before deletion, the skill is backed up to `~/.cc-switch-x/skill-backups/`
- Removes the skill from all app directories (Claude, Codex, Gemini, OpenCode, Hermes)
- Removes the skill from the SSOT directory (`~/.cc-switch-x/skills/`)
...
| ---------------------- | ------------------------------------------------------------------------------------------------------ |
| **CC Switch built-in** | Default location `~/.cc-switch-x/skills/`, managed by CC Switch                                        |
