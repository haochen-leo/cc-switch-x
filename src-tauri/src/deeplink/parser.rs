...
/// Parse a ccswitchx:// URL into a DeepLinkImportRequest.
///
/// Expected format:
/// ccswitchx://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != crate::brand::DEEP_LINK_SCHEME && scheme != "ccswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected '{}' or legacy 'ccswitch', got '{scheme}'",
            crate::brand::DEEP_LINK_SCHEME
        )));
    }
